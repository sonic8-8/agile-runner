...
@Getter
public class ManualRerunRetryResponse {
    ...
    private ManualRerunRetryResponse(String executionKey,
    ...
    public static ManualRerunRetryResponse from(ManualRerunRetryServiceResponse response) {
        return new ManualRerunRetryResponse(
                response.getExecutionKey(),
                response.getRetrySourceExecutionKey(),
